...
ArrayJ Tier6::remove_holes(DeviceJ * device, ArrayJ * src, ArrayJ * dst, float max_size)
{
    return ArrayJ{cle::tier6::remove_holes_func(device->get(), src->get(), dst == nullptr ? nullptr : dst->get(), max_size)};
}
