...
ArrayJ Tier5::remove_small_objects(DeviceJ * device, ArrayJ * src, ArrayJ * dst, float min_size)
{
    return ArrayJ{cle::tier5::remove_small_objects_func(device->get(), src->get(), dst == nullptr ? nullptr : dst->get(), min_size)};
}

ArrayJ Tier5::remove_big_objects(DeviceJ * device, ArrayJ * src, ArrayJ * dst, float max_size)
{
    return ArrayJ{cle::tier5::remove_big_objects_func(device->get(), src->get(), dst == nullptr ? nullptr : dst->get(), max_size)};
}
