...
public class Tier5 {
	 ...
	 * @param min_size (float) - Smallest size object allowed. (default: 100)
	 * @return {@link ArrayJ}
	 * @see https://clij.github.io/clij2-docs/reference_excludeLabelsOutsideSizeRange
	 * @throws NullPointerException if any of the device or input parameters are null.
	 */
    public static ArrayJ removeSmallObjects(DeviceJ device, ArrayJ input, ArrayJ output, float min_size) {
        Objects.requireNonNull(device, "device cannot be null");
		Objects.requireNonNull(input, "input cannot be null");
        return new ArrayJ(net.clesperanto._internals.kernelj.Tier5.remove_small_objects(device.getRaw(), input.getRaw(), output == null ? null : output.getRaw(), min_size), device);
    }
	 ...
	 * @param input ({@link ArrayJ}) - Label image to filter.
	 * @param output ({@link ArrayJ}) - Output label image fitlered. (default: None)
	 * @param max_size (float) - Biggest size object allowed. (default: 100)
	 * @return {@link ArrayJ}
	 * @see https://clij.github.io/clij2-docs/reference_excludeLabelsOutsideSizeRange
	 * @throws NullPointerException if any of the device or input parameters are null.
	 */
    public static ArrayJ removeBigObjects(DeviceJ device, ArrayJ input, ArrayJ output, float max_size) {
        Objects.requireNonNull(device, "device cannot be null");
		Objects.requireNonNull(input, "input cannot be null");
        return new ArrayJ(net.clesperanto._internals.kernelj.Tier5.remove_big_objects(device.getRaw(), input.getRaw(), output == null ? null : output.getRaw(), max_size), device);
    }
