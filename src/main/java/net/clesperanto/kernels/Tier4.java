...
public class Tier4 {
	 ...
	 * @param output ({@link ArrayJ}) - Output label image. (default: None)
	 * @param min_size (float) - Minimum size of labels to keep. (default: 0)
	 * @param max_size (float) - Maximum size of labels to keep. (default: 100)
	 * @return {@link ArrayJ}
	 * @see https://clij.github.io/clij2-docs/reference_excludeLabelsOutsideSizeRange
	 * @throws NullPointerException if any of the device or input parameters are null.
	 */
    public static ArrayJ filterLabelBySize(DeviceJ device, ArrayJ input, ArrayJ output, float min_size, float max_size) {
        Objects.requireNonNull(device, "device cannot be null");
		Objects.requireNonNull(input, "input cannot be null");
        return new ArrayJ(net.clesperanto._internals.kernelj.Tier4.filter_label_by_size(device.getRaw(), input.getRaw(), output == null ? null : output.getRaw(), min_size, max_size), device);
    }
