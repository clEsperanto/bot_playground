...
public class Tier3 {
    ...
    public static ArrayJ removeLabels(DeviceJ device, ArrayJ input, ArrayJ list, ArrayJ output) {
        ...
        return new ArrayJ(net.clesperanto._internals.kernelj.Tier3.remove_labels(device.getRaw(), input.getRaw(), list.getRaw(), output == null ? null : output.getRaw()), device);
    }
    ...
    public static ArrayJ removeLabelsOnEdges(DeviceJ device, ArrayJ input, ArrayJ output, boolean exclude_x, boolean exclude_y, boolean exclude_z) {
        Objects.requireNonNull(device, "device cannot be null");
		Objects.requireNonNull(input, "input cannot be null");
        return new ArrayJ(net.clesperanto._internals.kernelj.Tier3.remove_labels_on_edges(device == null ? null : device.getRaw(), input.getRaw(), output == null ? null : output.getRaw(), exclude_x, exclude_y, exclude_z), device);
    }
	 ...
	 * @param withBG (boolean) - Include the background label in the statistics. (default: False)
	 * @return StatisticsMap
	 * @throws NullPointerException if any of the device or input parameters are null.
	 */
    public static HashMap<String, ArrayList<Float>> statisticsOfLabelledPixels(DeviceJ device, ArrayJ input, ArrayJ intensity, boolean withBG) {
        Objects.requireNonNull(device, "device cannot be null");
		Objects.requireNonNull(input, "input cannot be null");
        return Utils.toHashMap(net.clesperanto._internals.kernelj.Tier3.statistics_of_labelled_pixels(device.getRaw(), input.getRaw(), intensity == null ? null : intensity.getRaw(), withBG));
    }
