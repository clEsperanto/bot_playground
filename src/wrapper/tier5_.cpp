...
m.def("_array_equal", &cle::tier5::array_equal_func, "Call cle::tier5::array_equal_func from C++ CLIc.",
    ...
    m.def("_remove_small_objects", &cle::tier5::remove_small_objects_func, "Call cle::tier5::remove_small_objects_func from C++ CLIc.",
    py::return_value_policy::take_ownership,
    py::arg("device"), py::arg("src"), py::arg("dst"), py::arg("min_size"));

    m.def("_remove_big_objects", &cle::tier5::remove_big_objects_func, "Call cle::tier5::remove_big_objects_func from C++ CLIc.",
    py::return_value_policy::take_ownership,
