...
def bottom_hat(
    ...
    return clic._bottom_hat(device, input_image, output_image, float(radius_x), float(radius_y), float(radius_z), connectivity)
...
def closing(
    ...
    return clic._closing(device, input_image, output_image, int(radius_x), int(radius_y), int(radius_z), connectivity)
...
def detect_maxima(
    ...
    return clic._detect_maxima(device, input_image, output_image, int(radius_x), int(radius_y), int(radius_z), connectivity)
...
def detect_minima(
    ...
    return clic._detect_minima(device, input_image, output_image, int(radius_x), int(radius_y), int(radius_z), connectivity)
...
def opening(
    ...
    return clic._opening(device, input_image, output_image, float(radius_x), float(radius_y), float(radius_z), connectivity)
...
def standard_deviation(
    ...
    return clic._standard_deviation(device, input_image, output_image, int(radius_x), int(radius_y), int(radius_z), connectivity)
...
def top_hat(
    ...
    return clic._top_hat(device, input_image, output_image, float(radius_x), float(radius_y), float(radius_z), connectivity)