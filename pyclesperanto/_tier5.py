...
def remove_small_objects(
    ...
    return clic._remove_small_objects(device, input_image, output_image, float(min_size))

@plugin_function(category=["label processing", "in assistant", "bia-bob-suggestion"])
def remove_big_objects(
    input_image: Image,
    output_image: Optional[Image] =None,
    max_size: float =100,
    device: Optional[Device] =None
    ...
    return clic._remove_big_objects(device, input_image, output_image, float(max_size))